...
/**
 * This Payment object reprents all the necessary
 * data to verify a receipt.
 * 
 * This is basically an interface to the server payload
 * on `APIPaymentBody`.
 * 
 * @see https://developer.apple.com/library/archive/releasenotes/General/ValidateAppStoreReceipt/Chapters/ValidateRemotely.html#//apple_ref/doc/uid/TP40010573-CH104-SW3
 */
export interface Payment {
  /**
   * The receipt is a base64 encoded string generated by the app.
   */
  receipt: string;
  /**
   * The secret is your app shared secret (a hexadecimal value).
   */
  secret: string;
  /**
   * If value is true, response includes only the latest renewal
   * transaction for any subscriptions.
   */
  excludeOldTransactions?: boolean;
  /**
   * The product ID which your user is paying for.
   */
  productId?: string;
  /**
   * Your app bundle ID (commonly something like `com.company.app`)
   */
  packageName?: string;
}

/**
 * This Receipt object is returned if the receipt is valid
 * and is used to validate the user's subscription.
 */
