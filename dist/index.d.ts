import { AppleReceiptResponse } from './lib/apple';
import { GoogleReceiptResponse } from './lib/google';
export { default as IapError } from './iap-error';
export declare type Platform = 'google' | 'apple';
 ...
 */
export declare function verifyPayment(platform: Platform, payment: Payment): Promise<Receipt>;
